...
`alx-africa` • `prodev` • `frontend` • `backend` • `full-stack` • `react-native` • `django` • `typescript` • `python` • `postgresql` • `docker` • `api` • `rest-api` • `graphql` • `mobile-development` • `web-development` • `pwa` • `nextjs` • `tailwindcss` • `expo` • `celery` • `ci-cd` • `documentation` • `learning` • `capstone-project`

---

**Project Status:** ✅ Complete | 🎯 Ready for Review | 🚀 Production Ready

**Program:** ALX ProDev Frontend & Backend Engineering  
**Timeline:** September 8 - 28, 2025  
**Submission Date:** September 28, 2025  

**Scores:**
- Frontend Average: 110.23% ⭐
- Backend Average: 112.0% ⭐

---

### ⭐ If this documentation helped you, please give it a star! ⭐

### 💬 Questions? Reach out on Discord: `#ProDevProjectNexus`
